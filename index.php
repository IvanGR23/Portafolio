<?php 
    ...
    $curdx = $cursodestacado->get_curso_destacados();
                ...
                <div class="row">
                    <div class="col-lg-8 mb-30">
                        <div class="carausel-post-1 hover-up border-radius-10 overflow-hidden transition-normal position-relative wow fadeInUp animated">
                            ...
                            <div class="position-relative post-thumb">
                                    <div class="thumb-overlay img-hover-slide position-relative" style="background-image: url(assets/imgs/news/<?php echo $curdx[$i]["cur_img"]?>)">
                                        ...
                                        <div class="post-content-overlay text-white ml-30 mr-30 pb-30">
                                            <div class="entry-meta meta-0 font-small mb-20">
                                                ...
                                                <a href="category.html"><span class="post-cat text-success text-uppercase">MYSQL</span></a>
                                                <a href="category.html"><span class="post-cat text-warning text-uppercase">JAVASCRIPT</span></a>
                                            </div>
                                            <h3 class="post-title font-weight-900 mb-20">
                                                <a class="text-white" href="single.html"><?php echo $curdx[$i]["cur_titulo"]?></a>
                                            </h3>
                                            <div class="entry-meta meta-1 font-small text-white mt-10 pr-5 pl-5">
                                                <span class="post-on"><?php echo $curdx[$i]["cur_subtitulo"]?></span>
                    ...
                    <article class="col-lg-4 col-md-6 mb-30 wow fadeInUp animated" data-wow-delay="0.2s">
                        <div class="post-card-1 border-radius-10 hover-up">
                            <div class="post-thumb thumb-overlay img-hover-slide position-relative" style="background-image: url(assets/imgs/news/<?php echo $curx[$i]["cur_img"]?>)">
                            ...
                            <div class="post-content p-30">
                                ...
                                <div class="d-flex post-card-content">
                                    <h5 class="post-title mb-20 font-weight-900">
                                        <a href="single.html"><?php echo $curx[$i]["cur_titulo"]?></a>
                                    </h5>
                                    <div class="entry-meta meta-1 float-left font-x-small text-uppercase">
                                        <span class="post-on"><?php echo $curx[$i]["cur_subtitulo"]?></span>
    ...
    <footer class="pt-50 pb-20 bg-grey">
        <div class="container">
            ...
            <div class="footer-copy-right pt-30 mt-20 wow fadeInUp animated">
                <p class="float-md-left font-small text-muted">© 2022, IGR </p>
